                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-6 col-sm-12">
                              <fieldset>
                                ...
                                <select name="name" type="text" id="name" placeholder="" required="">
                                    <option value="" disabled selected>Select the product*</option>
                                    <option value="">Sandwich</option>
                                    <option value="">Sambusa</option>
                                    <option value="">Gateau</option>
                                </select>
                              </fieldset>
                            </div>
                            <div class="col-lg-6 col-sm-12">
                              ...
                              <label for="">Product quantity</label>
                                <input name="quantity" type="number" id="name" placeholder="Quantity*" required="">
                              </fieldset>
                            </div>
                            <div class="col-lg-12 col-sm-12">
                              <fieldset>
                              <label for="">Delivery destination</label>
                                <input name="address" type="text" id="name" placeholder="Your street address*" required="">
                              </fieldset>
                            </div>
                            <div class="col-lg-6 col-sm-12">
                              <fieldset>
                              <label for="">Delivery date</label>
                                <input name="delivery_date" type="date" id="" placeholder="Date*" required="">
                              </fieldset>
                            </div>
                            <div class="col-lg-6 col-sm-12">
                              <fieldset>
                                  <label for="">Delivery time</label>
                                <input name="delivery_time" type="time" id="" placeholder="Time*" required="">
                              </fieldset>
                            </div>
                            <div class="col-lg-12">
                              <fieldset>
                                  <label for="">Order description</label>
                                <textarea name="description" rows="4" id="message" placeholder="How do you want to be your product?" required=""></textarea>
                              </fieldset>
                            </div>
                            <div class="col-lg-12">
                              <fieldset>
                                <button type="submit" id="form-submit" class="main-button-icon">Order now</button>
                              </fieldset>
                            </div>
                          </div>
                        </form>
